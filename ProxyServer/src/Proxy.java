...
public class Proxy implements Runnable{
	...
	* Semaphore for Proxy and Console Management System.???????????????
	 ...
	 */
	static HashMap<String, String> blockedSites;//הרשימה השחורה של האתרים החסומים
	...
	public void listen(){
		...
		while(running){
			try {
				...
				Thread req=new Thread(new RequestHandler(socket));//טיפול בבקשות כל אחת בנפרד
